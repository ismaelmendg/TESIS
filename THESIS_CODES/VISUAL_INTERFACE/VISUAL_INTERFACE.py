...
Bigger_rectangle_X = Bigger_rectangle_X = screen_width_o/2 - Bigger_rectangle_width/2
...
#                sendTiD(7712)
            ...
            if currentClass == 2:
                ...
                pygame.draw.circle(screen, arrowColor, (int(centerOfScreen[0]), int(Bigger_rectangle_Y + bar_height/2)),
                                   int(bar_height * 0.8),
                                   0)  # draw a colored filled circle to show result
                pygame.draw.circle(screen, bigRecEdgeColor, (int(centerOfScreen[0]), int(Bigger_rectangle_Y + bar_height/2)),
